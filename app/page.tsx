...
export default function StudyKarte() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-8 print:bg-white print:p-0 font-sans">
      <div className="max-w-4xl mx-auto space-y-6 print:space-y-0">
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm print:hidden">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-bold">学習計画の入力</h2>
          </div>
        ...
        {/* 【学習カルテ本体】 */}
        <div className="bg-white shadow-xl border border-gray-200 p-6 md:p-12 print:shadow-none print:border-none print:p-8 print:m-0 print:w-full">
          
          {/* ヘッダー */}
          <div className="flex justify-between items-end border-b-2 border-black pb-2 mb-6">
            <h1 className="text-2xl md:text-3xl font-bold tracking-[0.2em]">学 習 カ ル テ</h1>
            <div className="text-right text-[10px] md:text-xs text-gray-500 font-mono">
          ...
          <footer className="mt-8 pt-4 border-t border-gray-100 text-[9px] text-gray-400 flex justify-between items-center print:mt-12">
            ...
            <p className="font-mono uppercase tracking-tighter">REF: {Math.random().toString(36).substr(2, 6).toUpperCase()}</p>
          </footer>
        </div>
        ...
        <div className="flex justify-center pb-12 print:hidden">
          <button 
            ...
            className="flex items-center gap-2 px-10 py-4 text-lg font-bold text-white bg-black hover:bg-gray-800 rounded-full transition-all shadow-lg active:scale-95"
          >
